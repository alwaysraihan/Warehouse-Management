...
const Inventory = () => {
  ...
  return (
    <>
      <h1>I'm inventory item and my id:{inventoryItem.length}</h1>
            ...
            <div className="flex justify-center items-center px-2 pb-2">
              ...
              <div className="w-1/2 p-2">
                <Link
                  ...
                  className="block text-center cursor-pointer bg-white hover:bg-gray-100 text-teal-500 border-2 border-teal-500 px-3 py-2 rounded uppercase font-poppins font-medium"
                >
                  Update
                </Link>
              </div>
