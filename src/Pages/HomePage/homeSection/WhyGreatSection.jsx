          ...
          <div className="md:pt-14 pb-20 md:pb-28 grid lg:gap-x-12 lg:grid-cols-3">
            <div className="mb-12 lg:mb-0">
              <div className="rounded-lg shadow-lg h-full block bg-white">
                ...
                <div className="p-6">
                  ...
                  <h5 className="text-lg font-medium mb-4">Components</h5>
            ...
            <div className="mb-12 lg:mb-0">
              <div className="rounded-lg shadow-lg h-full block bg-white">
                ...
                <div className="p-6">
                  <h3 className="text-2xl font-bold text-blue-600 mb-4">70%</h3>
            ...
            <div className="">
              <div className="rounded-lg shadow-lg h-full block bg-white">
                ...
                <div className="p-6">
                  <h3 className="text-2xl font-bold text-blue-600 mb-4">49</h3>
